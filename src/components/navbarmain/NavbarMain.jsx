            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav className="ms-auto my-1 my-lg-0 justify-content-center align-itens.center">
                        <Nav.Link as={Link} to="/home" className="btn justify-content-center">Home</Nav.Link>
                        <Nav.Link as={Link} to="/cities" className="btn justify-content-center">Cities</Nav.Link>
