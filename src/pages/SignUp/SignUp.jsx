            ...
            <div className="flex-auto p-6 mx-5 my-2">
                <Form role="form text-left" onSubmit={handleSubmitData}>
                    ...
                    <Row>
                        ...
                        <Form.Group className="mb-2">
                            <Form.Control name="photo" ref={photo} onChange={handleChangeData} defaultValue="https://www.pngmart.com/files/22/User-Avatar-Profile-Transparent-Isolated-PNG.png" value={data.photo} aria-describedby="photo-addon" aria-label="Photo" placeholder="Photo" className="text-sm focus-shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus-border-fuchsia-300 focus-bg-white focus-text-gray-700 focus-outline-none focus-transition-shadow" type="text" />
                        </Form.Group>
                    </Row>
