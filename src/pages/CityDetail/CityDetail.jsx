                                        ...
                                        <div className="frame-screen">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="card-2">
                                                    <div className="text-wrapper-2">Country: {cityData.title}</div>
